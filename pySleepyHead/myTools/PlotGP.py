...
def gp_plot(mo, mv, filename, fig_files=None, plot_title=None, fig_list=None, ref_str='_ref', test_str='_test'):
    ...
    plq(plt, mv, 'time', mv, 'st_state', color='black', linestyle='-.', label='st_state' + test_str)
    ...
    plq(plt, mv, 'time', mv, 'flt_LTST', slr=0.25, add=0.75, color='magenta', linestyle='-', label='flt_LTST' + test_str)
    plt.legend(loc=1)
    plt.subplot(236)
