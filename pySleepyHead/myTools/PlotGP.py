...
def gp_plot(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, fig_list=None,
    ...
    plt.legend(loc=1)
    plt.subplot(222)
    plq(plt, mo, 'time', mo, 'eye_cl', color='black', linestyle='-', label='eye_cl' + ref_str)
    plq(plt, mo, 'time', mo, 'conf', color='orange', linestyle='-', label='conf' + ref_str)
    plt.legend(loc=1)
    plt.subplot(223)
    plq(plt, mo, 'time', mo, 'max_nod_f', color='black', linestyle='-', label='max_nod_f' + ref_str)
    plq(plt, mo, 'time', mo, 'max_nod_p', color='black', linestyle='-', label='max_nod_f' + ref_str)
    plt.legend(loc=1)
    plt.subplot(224)
    plq(plt, mo, 'time', mo, 'buzz', color='black', linestyle='-', label='buzz' + ref_str)
    plt.legend(loc=1)
