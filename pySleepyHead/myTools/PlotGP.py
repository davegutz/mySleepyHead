...
def gp_plot(mo, mv, filename, fig_files=None, plot_title=None, fig_list=None, ref_str='_ref', test_str='_test'):
    ...
    plq(plt, mo, 'time', mo, 'eye_tone', slr=0.25, add=0.75, color='red', linestyle='-', label='eye_tone' + ref_str + '*.75+.25')
    plq(plt, mv, 'time', mv, 'eye_tone', slr=0.25, add=0.75, color='blue', linestyle='--', label='eye_tone' + test_str + '*.75+.25')
    plt.legend(loc=1)
    ax = plt.subplot(133)
    plq(plt, mo, 'time', mo, 'eye_tone', add=14, color='red', linestyle='-', label='eye_tone+' + ref_str + '+14')
    plq(plt, mv, 'time', mv, 'eye_tone', add=14, color='blue', linestyle='--', label='eye_tone' + test_str + '14')
    ...
    plq(plt, mo, 'time', mo, 'yaw_eye_reset', add=20, color='red', linestyle='-', label='yaw_eye_reset' + ref_str + '+20')
    plq(plt, mv, 'time', mv, 'yaw_eye_reset', add=20, color='blue', linestyle='--', label='yaw_eye_reset' + test_str + '+20')
    plq(plt, mo, 'time', mo, 'eye_reset_RLR', add=-20, color='red', linestyle='-', label='eye_reset_RLR' + ref_str + '-20')
    plq(plt, mv, 'time', mv, 'eye_reset_RLR', add=-20, color='blue', linestyle='--', label='eye_reset_RLR' + test_str + '-20')
    plq(plt, mo, 'time', mo, 'eye_reset_LRL', add=-30, color='red', linestyle='-', label='eye_reset_LRL' + ref_str + '-30')
    plq(plt, mv, 'time', mv, 'eye_reset_LRL', add=-30, color='blue', linestyle='--', label='eye_reset_LRL' + test_str + '-30')
    ...
    plq(plt, mo, 'time', mo, 'st_state', color='blue', linestyle='-', label='st_state' + ref_str)
    plq(plt, mv, 'time', mv, 'st_state', color='red', linestyle='--', label='st_state' + test_str)
    plq(plt, mo, 'time', mo, 'eye_tone', slr=0.25, add=0.75, color='red', linestyle='-', label='eye_tone' + ref_str + '*.25+.75')
    plq(plt, mv, 'time', mv, 'eye_tone', slr=0.25, add=0.75, color='blue', linestyle='--', label='eye_tone' + test_str + '*.25+.75')
    plq(plt, mv, 'time', mv, 'flt_thr_pos', color='black', linestyle='-.', label='flt_thr_pos' + test_str)
    plq(plt, mo, 'time', mo, 'dltst', color='blue', linestyle='-', label='dltst' + ref_str)
    plq(plt, mv, 'time', mv, 'dltst', color='red', linestyle='--', label='dltst' + test_str)
    plq(plt, mv, 'time', mv, 'frz_thr_pos', color='blue', linestyle='-.', label='frz_thr_pos' + test_str)
