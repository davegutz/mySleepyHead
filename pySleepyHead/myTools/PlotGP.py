...
def gp_plot(mo, mv, filename, fig_files=None, plot_title=None, fig_list=None, ref_str='_ref', test_str='_test'):
    ...
    plq(plt, mv, 'time', mv, 'O_QUIET_THR', add= 2, color='magenta', linestyle=':', label='O_QUIET_THR' + test_str + '+2')
    plq(plt, mv, 'time', mv, 'O_QUIET_THR', slr=-1, add= 2, color='magenta', linestyle=':', label='O_QUIET_THR' + test_str + '+2')
    plt.legend(loc=1)
    plt.subplot(235)
