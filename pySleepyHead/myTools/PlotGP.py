...
def gp_plot(mo, mv, filename, fig_files=None, plot_title=None, fig_list=None, ref_str='_ref', test_str='_test'):
    ...
    plq(plt, mo, 'time', mo, 'eye_reset_RLR', add=0, color='red', linestyle='-', label='eye_reset_RLR' + ref_str + '-0')
    plq(plt, mv, 'time', mv, 'eye_reset_RLR', add=0, color='blue', linestyle='--', label='eye_reset_RLR' + test_str + '-0')
    plq(plt, mo, 'time', mo, 'eye_reset_LRL', add=-2, color='red', linestyle='-', label='eye_reset_LRL' + ref_str + '-2')
    plq(plt, mv, 'time', mv, 'eye_reset_LRL', add=-2, color='blue', linestyle='--', label='eye_reset_LRL' + test_str + '-2')
